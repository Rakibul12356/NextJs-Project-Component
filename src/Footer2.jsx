...
const Footer2 = () => {
    ...
    return (
        <footer className=" mt-12 relative border-t border-white/10 py-16  
              px-4 sm:px-0 md:p-0 lg:p-0  overflow-hidden">
  ...
  {/* Content */}
  <div className="relative z-10 flex flex-col sm:flex-row justify-between gap-10 px-4">
    {/* Left Section */}
